...
var Customer = (function () {
    function Customer(id, phoneNo, linkFacebook, cardReward, active, totalWheel) {
        this.id = id;
...
/***/ "../../../../../src/app/providers/urlProvider.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resources_urlResource__ = __webpack_require__("../../../../../src/app/resources/urlResource.ts");
...
var UrlProvider = (function () {
    function UrlProvider() {
        this.home = "/" + __WEBPACK_IMPORTED_MODULE_0__resources_urlResource__["a" /* UrlResource */].home;
        this.card = "/" + __WEBPACK_IMPORTED_MODULE_0__resources_urlResource__["a" /* UrlResource */].home + "/" + __WEBPACK_IMPORTED_MODULE_0__resources_urlResource__["a" /* UrlResource */].card;
    }
    return UrlProvider;
}());
...
/***/ "../../../../../src/app/resources/apiResource.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ApiResource; });
var ApiResource = (function () {
    function ApiResource() {
        this.baseUrl = ApiResource.getApiBaseUrl();
    }
    ApiResource.getApiBaseUrl = function () {
    ...
    ApiResource.getCustomer = function (id) {
        return this.devUrl + this.customer + id;
    };
    ApiResource.randomCard = function (id) {
        return this.devUrl + this.cardRandom + id;
    };
    return ApiResource;
}());

ApiResource.localUrl = 'http://localhost:56231/api/';
ApiResource.devUrl = 'http://amrstore-001-site1.ftempurl.com/api/';
ApiResource.baseUrl = '';
ApiResource.customer = 'customer/';
ApiResource.cardRandom = 'cardr/';
ApiResource.updateCustomer = ApiResource.devUrl + ApiResource.customer;
//# sourceMappingURL=apiResource.js.map

/***/ }),

/***/ "../../../../../src/app/services/base/baseService.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServiceBase = (function () {
    function ServiceBase() {
        this.postOptions = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* RequestOptions */]({
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* Headers */]({ 'Content-Type': 'application/json' }),
            method: "POST"
        });
        this.getOptions = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* RequestOptions */]({
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* Headers */]({ 'Content-Type': 'application/json' }),
            method: "GET"
        });
        this.putOptions = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* RequestOptions */]({
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* Headers */]({ 'Content-Type': 'application/json' }),
            method: "PUT"
        });
        this.deleteOptions = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* RequestOptions */]({
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* Headers */]({ 'Content-Type': 'application/json' }),
            method: "DELETE"
        });
    }
    ServiceBase.prototype.basicAuth = function (username, password) {
        return new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* RequestOptions */]({
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* Headers */]({ 'Authorization': 'Basic ' + btoa(username + ':' + password) }),
        });
    };
...
var CustomerService = (function (_super) {
    ...
    CustomerService.prototype.getCustomer = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__resources_apiResource__["a" /* ApiResource */].getCustomer(id))
            .toPromise()
    ...
    CustomerService.prototype.updateCustomer = function (customer) {
        ...
        return this.http
            .put(__WEBPACK_IMPORTED_MODULE_4__resources_apiResource__["a" /* ApiResource */].updateCustomer, body, this.putOptions)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    CustomerService.prototype.randomCard = function (id) {
